...
import com.phr.common.constants.Constants;
...
public class HttpUtils {
	...
	public static String sendGet(String url, Map<String, String> params) throws Exception {
		return sendGet(url, params, Constants.DEFAULT_CONNECT_TIMEOUT, Constants.DEFAULT_READ_TIMEOUT, UTF8);
	}
	...
	public static String sendGet(String url, Map<String, String> params, int connectTimeout, int readTimeout, String charset) throws Exception {
		...
		try {
			...
			if (!url.contains("/ds/")) {
				logger.info("url:" + url + " 请求时间：" + (System.currentTimeMillis() - start) / 1000 + "秒");
			}
			try {
				if (in != null) {
					in.close();
	...
	public static String sendGetUnCompress(String url, Map<String, String> params, Map<String, String> heads) throws Exception {
		return sendGetUnCompress(url, params, heads, Constants.DEFAULT_CONNECT_TIMEOUT, Constants.DEFAULT_READ_TIMEOUT, HttpUtils.UTF8);
	}
	...
	public static String sendGet(String url, Map<String, String> params, Map<String, String> heads) throws Exception {
		...
		try {
			...
			logger.error("@@@发送httpGet请求：URL=【" + url + "】;params【" + FastJsonUtils.toJson(params) + "】;connectTimeout=【" + Constants.DEFAULT_CONNECT_TIMEOUT + "】；readTimeout=【" + Constants.DEFAULT_READ_TIMEOUT + "】;异常信息：", e);
			throw new RuntimeException("发送GET请求出现异常！", e);
		} finally {/** 使用finally块来关闭输入流 **/
			if (!url.contains("/ds/")) {
				logger.info("url:" + url + " 请求时间：" + (System.currentTimeMillis() - start) / 1000 + "秒");
			...
			try {
				...
				logger.error("@@@发送httpGetIO请求：URL=【" + url + "】;params【" + FastJsonUtils.toJson(params) + "】;connectTimeout=【" + Constants.DEFAULT_CONNECT_TIMEOUT + "】；readTimeout=【" + Constants.DEFAULT_READ_TIMEOUT + "】;异常信息：", ex);
				throw new RuntimeException("发送GET请求出现异常！", ex);
			}
		}
		return result;
...
//			conn.setRequestProperty("Content-encoding", "application/json");
	...
	public static String sendPost(String url, String params) throws Exception {
		return sendPost(url, params, Constants.DEFAULT_CONNECT_TIMEOUT, Constants.DEFAULT_READ_TIMEOUT, UTF8);
	}
...
//			conn.setRequestProperty("Content-encoding", "application/json");
	...
	public static String sendPost(String url, String jsonParams, Map<String, String> heads) throws Exception {
		return sendPost(url, jsonParams, heads, Constants.DEFAULT_CONNECT_TIMEOUT, Constants.DEFAULT_READ_TIMEOUT, UTF8);
	}
}