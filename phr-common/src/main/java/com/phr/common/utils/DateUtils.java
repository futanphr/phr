...
public class DateUtils {
     ...
     */
    public static String formatDateTime(java.util.Date dtmDate, String strFormat) {
    ...
    public static String getFormatCurrentDate(String strFormat) {
        return formatDateTime(getCurrentDate(), strFormat);
    }
    ...
    public static String getCurrentDateSplit() {
        return DateUtils.getFormatCurrentDate(DATE_SIMPLE_STR);
    }
     ...
     * @date 2017年11月6日
     */
	public static String getDayBegin(Date date, String pattern) {
		SimpleDateFormat simpleDateFormat = new SimpleDateFormat(pattern);
        Calendar calender = Calendar.getInstance();
        calender.setTime(date);
